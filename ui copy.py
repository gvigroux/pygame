...
class BackMeUp(ttk.Frame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.img_properties_d = tkinter.PhotoImage(name='properties-dark', file=p / 'assets/icons8-settings-50.png')
        self.img_properties_l = tkinter.PhotoImage(name='properties-light', file=p / 'assets/icons8-settings-50.png')
        self.img_addtobackup_d = tkinter.PhotoImage(name='add-to-backup-dark', file=p / 'assets/icons8-settings-50.png')
        self.img_addtobackup_l = tkinter.PhotoImage(name='add-to-backup-light', file=p / 'assets/icons8-settings-50.png')
        self.img_stopbackup_d = tkinter.PhotoImage(name='stop-backup-dark', file=p / 'assets/icons8-settings-50.png')
        self.img_stopbackup_l = tkinter.PhotoImage(name='stop-backup-light', file=p / 'assets/icons8-settings-50.png')
        self.img_play = tkinter.PhotoImage(name='play', file=p / 'assets/icons8-settings-50.png')
        self.img_refresh = tkinter.PhotoImage(name='refresh', file=p / 'assets/icons8-settings-50.png')
        self.img_stop_d = tkinter.PhotoImage(name='stop-dark', file=p / 'assets/icons8-settings-50.png')
        self.img_stop_l = tkinter.PhotoImage(name='stop-light', file=p / 'assets/icons8-settings-50.png')
        self.img_opened_folder = tkinter.PhotoImage(name='opened-folder', file=p / 'assets/icons8-settings-50.png')
        self.img_logo = tkinter.PhotoImage(name='logo', file=p / 'assets/icons8-settings-50.png')
...
class CollapsingFrame(ttk.Frame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.images = [tkinter.PhotoImage(name='open', file=p / 'assets/icons8-settings-50.png'),
                       tkinter.PhotoImage(name='closed', file=p / 'assets/icons8-settings-50.png')]
